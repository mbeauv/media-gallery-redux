...
export function createImageInfo(
  ...
  return async (dispatch) => {
    ...
    try {
      ...
      const response = await mediaGalleryCommunicator().post(imgUrl, {
        name,
        description,
      });
...
export function updateImageInfo(
  ...
  return async (dispatch) => {
    ...
    try {
      ...
      const response = await mediaGalleryCommunicator().put(imgUrl, {
        name,
        description,
      });
...
export function deleteImageInfo(authToken: string, galleryId: number, imageInfoId: number):
  ...
  return async (dispatch) => {
    ...
    try {
      ...
      await mediaGalleryCommunicator().delete(imgUrl);
...
export function getImageInfos(authToken: string, galleryId: number): MediaGalleryThunkAction {
  return async (dispatch) => {
    ...
    try {
      ...
      const response = await mediaGalleryCommunicator().get(imgUrl);
